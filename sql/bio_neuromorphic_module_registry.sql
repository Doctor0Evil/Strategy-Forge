CREATE TABLE IF NOT EXISTS neuromorphic_module (
    ...
    module_type             TEXT NOT NULL,  -- 'biodegradable_chipset','xr_bridge','neuromorphic_sensor'
    substrate_material      TEXT NOT NULL,  -- e.g. 'PLA','PLGA'
    conductive_material     TEXT NOT NULL,  -- e.g. 'Mg','Zn','transient_polymer'
    compatible_chipset      TEXT NOT NULL,  -- e.g. 'MT6883_Dimensity_1000'
